<template>
  ...
  <a-row class="pl-3 pr-3" style="font-size: 14px; color: #6761cc">
    <a-col :sm="24" :md="12" :lg="12"> 总大小 </a-col>
    <a-col :sm="24" :md="12" :lg="12" align="right" v-if="isShow">
      {{ sysInfo.system.diskTotal }}
    </a-col>
  </a-row>
  <hr style="margin-top: 10px; margin-bottom: 10px" />
  <a-row class="pl-3 pr-3" style="font-size: 14px; color: #1a9287">
    <a-col :sm="24" :md="12" :lg="12"> 剩余大小 </a-col>
    <a-col :sm="24" :md="12" :lg="12" align="right" v-if="isShow">
      {{ sysInfo.system.diskUsed }}
    </a-col>
  </a-row>
</template>
<script lang="ts">
    ...
    watch: {
      datas: {
        ...
        handler(newVal) {
          this.isShow = true;
          this.sysInfo = newVal;
          this.m2R2Data[0].value = parseFloat(newVal.system.diskPercent);
          this.m2R2Data[1].value = 100 - this.m2R2Data[0].value;
          this.theSetOptions(newVal.system.diskPercent, this.m2R2Data);
        },
      },
    },
    setup() {
      ...
      const m2R2Data = ref([
        { value: 0, name: '使用率', itemStyle: { color: 'green' } },
