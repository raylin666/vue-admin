...
<script lang="ts">
  ...
  const m2R2Data = [
    { value: 76.92, name: '使用率', itemStyle: { color: 'green' } },
    { value: 23.08, name: '剩余率', itemStyle: { color: '#cccccc' } },
  ];
